...
class TicTacToe:
        ...
        while True:
            ...
            if player == 'X':
                if not a1:
                    ...
                    print()
                    # fixing the spot
                    jugada_realizada = self.fix_spot(row - 1, col - 1, player, True)
                else:
                    row, col = a1.politica()
                    jugada_realizada = self.fix_spot(row, col, player, True)
                    if ver:
                        time.sleep(2)
            else:
                if not a2:
                    ...
                    print()
                    # fixing the spot
                    jugada_realizada = self.fix_spot(
    ...
    def startQvsRand(self, ver, a1, a2):
